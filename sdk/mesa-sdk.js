  ...
  const Mesa = {
    ...
    config: {
      getResolution: function () {
        // Return game's native resolution as configured in portal
        if (currentConfig && currentConfig.resolution) {
          const res = currentConfig.resolution;
          return {
            width: res.width || 1920,
            height: res.height || 1080,
            aspectRatio: res.aspectRatio || '16:9'
          };
        }
